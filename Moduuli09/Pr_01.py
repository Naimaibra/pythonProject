...
class Car:
    ...
    def print_info(self):
        print(f"Rekkari{Fore.YELLOW}" f"Huippunopeus{self.max_speed}" f"matkamittari{self.odometer}" f"nopeus {self.speed}")
...
for car in cars:
    if car.odometer >= 10000:
        print(f"{Fore.GREEN}Voittaja on {car.register_number}")
"""""
...
for car in cars:
    if car.odometer >= 10000:
        print(f" Voittaja on {car.register_number}")
"""""